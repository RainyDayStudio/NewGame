...
// Handles triggering and updating quests from any entity that parents this node
public partial class QuestManager : Node {
	...
	// Keeps track of the current loaded quest ID
	...
	public override void _Ready() {
		Controller = GetNode<QuestController>("QuestController");
	}
